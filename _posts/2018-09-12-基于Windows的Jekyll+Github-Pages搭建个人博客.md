...
![1552648939715](C:\Users\Kaku\AppData\Roaming\Typora\typora-user-images\阿里域名解析设置.png)

接下来在github该博客的仓库里，添加`CNAME`文件（无后缀名），其内容仅为一行，即你购买的域名。

![1552649317536](C:\Users\Kaku\AppData\Roaming\Typora\typora-user-images\1552649317536.png)
...
```
# URL
url:                "https://kakuoo.github.io" # the base hostname 主机名 & 协议 protocol for your site 
